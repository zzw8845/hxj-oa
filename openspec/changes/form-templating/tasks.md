...
- [x] 4.2 详情按合并数组渲染；驳回重提回填
- [x] 4.3 快捷菜单改由 enabled 模板派生（quick_document 界面退役）

## 5. 模板编辑器（M4）
- [x] 5.1 模板列表/字段编辑器（增删改排序/启停/保留字段锁定）
- [x] 5.2 流程绑定选择器

## 6. 收尾（M5）
- [x] 6.1 全量回归 146+ 用例；契约/架构测试更新
- [x] 6.2 文档同步（权限模型设计说明/表单模板化方案勾欠账）；quick_document 物理 DROP 由 V29 完成（任务 2.5 的表退役）
