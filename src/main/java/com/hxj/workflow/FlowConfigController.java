...
public class FlowConfigController {
    ...
    public ApiResponse<List<FlowConfigItems.FlowConfigSummary>> list() {
    ...
    public ApiResponse<FlowConfigItems.FlowConfigDetail> detailByType(
    ...
    public ApiResponse<FlowConfigItems.FlowConfigDetail> detail(@PathVariable Long id) {
    ...
    public ApiResponse<FlowConfigItems.FlowConfigDetail> create(@RequestBody FlowConfigItems.SaveFlowConfigRequest request) {
    ...
    @PreAuthorize("hasAuthority('CONFIGURE_FLOW_PERMISSION')")
    public ApiResponse<FlowConfigItems.FlowConfigDetail> update(
