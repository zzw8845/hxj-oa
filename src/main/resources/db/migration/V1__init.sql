-- =====================================================================
-- V1 基线：海峡金 OA 全量 schema + 干净种子数据（压平重建 v4，2026-09-15）
-- v4 = 图模型重构版。相对 v3 的结构升级：
--   * flow_transition 转移边表（图模型拓扑）——替代"线性链+条件规则goto跳转"，
--     语义：按优先级求值条件边，全不命中走无条件边；线性链是图的特例
--   * flow_node_config.assignee_type/assignee_value——结构化审批人协议
--     （ROLE/MANAGER/MANAGER_CHAIN/DEPT_ACCOUNTANT/INITIATOR/SELF_SELECT），
--     替代"中文节点名/角色名字符串特判"；ROLE 候选组存角色ID（与改名解耦）
--   * flow_config.status/version——发布两态（草稿/已发布），保存≠生效
--   * oa_document.department_id——单据部门ID外键，可见性按ID匹配
--   * flow_condition_rule 表退役（数据已迁入 flow_transition）
-- 其余设计决策同 v3：18 角色 / 职能服务范围 ALL / 核算会计 CUSTOM 含财务部 /
-- 汇报线跳级挂靠 / 部门负责人 leader_user_id / 20 条流程（已发布 v1）/ 核算分工不编造
-- =====================================================================
...
--
-- Table structure for table `flow_transition`
--
...
CREATE TABLE `flow_transition` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `flow_config_id` bigint NOT NULL,
  `from_node_id` bigint DEFAULT NULL COMMENT '源节点；orphanRemoval 断开时临时置空，业务非空由保存关口保证',
  `to_node_id` bigint DEFAULT NULL,
  `condition_variable` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `operator` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `expected_value` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sort_order` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `fk_transition_from` (`from_node_id`),
  KEY `fk_transition_to` (`to_node_id`),
  KEY `fk_transition_flow` (`flow_config_id`),
  CONSTRAINT `fk_transition_flow` FOREIGN KEY (`flow_config_id`) REFERENCES `flow_config` (`id`),
  CONSTRAINT `fk_transition_from` FOREIGN KEY (`from_node_id`) REFERENCES `flow_node_config` (`id`),
  CONSTRAINT `fk_transition_to` FOREIGN KEY (`to_node_id`) REFERENCES `flow_node_config` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=121 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='流程转移边（图模型拓扑）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='单据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_department` (
  ...
  `leader_user_id` bigint DEFAULT NULL COMMENT '部门负责人用户ID；主管类审批节点沿部门负责人树兜底解析（钉钉模式）',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2026-09-15  9:39:47
...
-- Dump completed on 2026-09-15  9:39:48
-- MySQL dump 10.13  Distrib 8.0.46, for macos26.4 (arm64)
--
-- Host: localhost    Database: oa
-- ------------------------------------------------------
...
INSERT INTO `sys_department` (`id`, `name`, `parent_id`, `sort_order`, `leader_user_id`, `created_at`, `updated_at`) VALUES (16,'总经办',NULL,1,45,'2026-09-10 10:18:42','2026-09-10 10:18:42'),(20,'财务中心',NULL,2,55,'2026-09-10 10:44:09','2026-09-10 10:44:17'),(22,'财务部',20,0,55,'2026-09-10 10:44:28','2026-09-10 10:44:28'),(23,'内控部',16,0,72,'2026-09-10 10:44:49','2026-09-10 10:44:49'),(24,'法务部',16,0,75,'2026-09-10 10:44:59','2026-09-15 09:05:08'),(25,'人力行政中心',NULL,3,52,'2026-09-10 10:45:18','2026-09-10 10:45:18'),(26,'行政部',25,0,52,'2026-09-10 10:45:31','2026-09-10 10:45:31'),(27,'业务支持中心',NULL,4,57,'2026-09-10 10:45:45','2026-09-10 10:45:57'),(28,'运营服务部',27,0,57,'2026-09-10 11:05:55','2026-09-10 11:05:55'),(29,'供应链中心',NULL,5,51,'2026-09-10 11:06:27','2026-09-10 11:06:27'),(30,'交付部',29,0,51,'2026-09-10 11:06:42','2026-09-10 11:06:42'),(31,'资管中心',NULL,6,NULL,'2026-09-10 11:06:53','2026-09-10 11:07:14');
...
INSERT INTO `flow_config` (`id`, `type`, `category`, `nodes`, `created_at`, `updated_at`, `status`, `version`) VALUES (1,'费用报销','DAILY',NULL,'2026-09-12 11:37:53','2026-09-15 09:37:21','PUBLISHED',1),(25,'闭店（入驻店销和代销）','DAILY',NULL,'2026-09-14 11:22:22','2026-09-15 09:37:21','PUBLISHED',1),(26,'费用预算','DAILY',NULL,'2026-09-14 11:22:24','2026-09-15 09:37:21','PUBLISHED',1),(27,'应付款申请','BUSINESS',NULL,'2026-09-14 11:22:24','2026-09-15 09:37:21','PUBLISHED',1),(28,'公司发文申请','DAILY',NULL,'2026-09-14 11:22:25','2026-09-15 09:37:21','PUBLISHED',1),(29,'固定资产报废报损','DAILY',NULL,'2026-09-14 11:22:25','2026-09-15 09:37:21','PUBLISHED',1),(30,'固定资产调拨','DAILY',NULL,'2026-09-14 11:22:25','2026-09-15 09:37:21','PUBLISHED',1),(31,'固定资产入库','DAILY',NULL,'2026-09-14 11:22:25','2026-09-15 09:37:21','PUBLISHED',1),(32,'借款申请','DAILY',NULL,'2026-09-14 11:22:26','2026-09-15 09:37:21','PUBLISHED',1),(33,'客户交易手续费调整','DAILY',NULL,'2026-09-14 11:22:26','2026-09-15 09:37:21','PUBLISHED',1),(34,'客户结算服务费','DAILY',NULL,'2026-09-14 11:22:26','2026-09-15 09:37:21','PUBLISHED',1),(35,'提货人新增或变更','DAILY',NULL,'2026-09-14 11:22:27','2026-09-15 09:37:21','PUBLISHED',1),(36,'通用审批申请','SEAL',NULL,'2026-09-14 11:22:27','2026-09-15 09:37:21','PUBLISHED',1),(37,'业务招待申请','DAILY',NULL,'2026-09-14 11:22:27','2026-09-15 09:37:21','PUBLISHED',1),(38,'银行账户管理调整','DAILY',NULL,'2026-09-14 11:22:27','2026-09-15 09:37:21','PUBLISHED',1),(39,'采购申请','DAILY',NULL,'2026-09-14 11:22:51','2026-09-15 09:37:21','PUBLISHED',1),(40,'低值易耗品（含办公物品）领用','DAILY',NULL,'2026-09-14 11:22:52','2026-09-15 09:37:21','PUBLISHED',1),(41,'非标合同审批及用印','SEAL',NULL,'2026-09-14 11:22:52','2026-09-15 09:37:21','PUBLISHED',1),(42,'黄金业务开户','DAILY',NULL,'2026-09-14 11:22:52','2026-09-15 09:37:21','PUBLISHED',1),(43,'用印及证照申请','SEAL',NULL,'2026-09-14 11:22:52','2026-09-15 09:37:21','PUBLISHED',1);
...
INSERT INTO `flow_node_config` (`id`, `flow_config_id`, `name`, `node_type`, `assignee_role`, `sort_order`, `cc_targets`, `assignee_type`, `assignee_value`) VALUES (335,1,'发起人','START',NULL,0,NULL,NULL,NULL),(336,1,'直属主管','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(337,1,'会计（按部门）','APPROVAL','会计（按部门）',2,NULL,'DEPT_ACCOUNTANT',NULL),(338,1,'会计主管&内控','APPROVAL','会计主管&内控',3,NULL,'ROLE','25'),(339,1,'公司领导（大额）','APPROVAL','公司领导',4,NULL,'ROLE','26'),(340,1,'出纳','APPROVAL','出纳',5,NULL,'ROLE','29'),(341,1,'抄送相关负责人','CC',NULL,6,'[{\"type\":\"ROLE\",\"value\":\"会计主管&内控\"},{\"type\":\"ROLE\",\"value\":\"出纳\"}]',NULL,NULL),(342,25,'发起人','START',NULL,0,NULL,NULL,NULL),(343,25,'直属主管','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(344,25,'商务专员','APPROVAL','商务专员',2,NULL,'ROLE','31'),(345,25,'执行总经理','APPROVAL','执行总经理',3,NULL,'ROLE','32'),(346,25,'会计主管&内控','APPROVAL','会计主管&内控',4,NULL,'ROLE','25'),(347,25,'出纳','APPROVAL','出纳',5,NULL,'ROLE','29'),(348,25,'抄送相关负责人','CC',NULL,6,'[{\"type\": \"ROLE\", \"value\": \"会计主管&内控\"}, {\"type\": \"ROLE\", \"value\": \"出纳\"}]',NULL,NULL),(349,26,'发起人','START',NULL,0,NULL,NULL,NULL),(350,26,'直属主管','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(351,26,'会计主管&内控','APPROVAL','会计主管&内控',2,NULL,'ROLE','25'),(352,26,'发起人自选抄送','CC',NULL,3,'[]',NULL,NULL),(353,27,'发起人','START',NULL,0,NULL,NULL,NULL),(354,27,'直属主管','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(355,27,'会计（按部门）','APPROVAL','会计（按部门）',2,NULL,'DEPT_ACCOUNTANT',NULL),(356,27,'会计主管&内控','APPROVAL','会计主管&内控',3,NULL,'ROLE','25'),(357,27,'公司领导（大额）','APPROVAL','公司领导',4,NULL,'ROLE','26'),(358,27,'出纳','APPROVAL','出纳',5,NULL,'ROLE','29'),(359,27,'抄送相关负责人','CC',NULL,6,'[{\"type\": \"ROLE\", \"value\": \"会计主管&内控\"}, {\"type\": \"ROLE\", \"value\": \"出纳\"}]',NULL,NULL),(360,28,'发起人','START',NULL,0,NULL,NULL,NULL),(361,28,'逐级主管','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(362,28,'法务','APPROVAL','法务',2,NULL,'ROLE','34'),(363,28,'内控主管','APPROVAL','内控主管',3,NULL,'ROLE','28'),(364,28,'执行总经理','APPROVAL','执行总经理',4,NULL,'ROLE','32'),(365,28,'行政专员编号发文','APPROVAL','行政专员',5,NULL,'ROLE','36'),(366,28,'发起人自选抄送','CC',NULL,6,'[]',NULL,NULL),(367,29,'发起人','START',NULL,0,NULL,NULL,NULL),(368,29,'资产归属部门确认','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(369,29,'财务经理','APPROVAL','财务经理',2,NULL,'ROLE','38'),(370,29,'执行总经理','APPROVAL','执行总经理',3,NULL,'ROLE','32'),(371,29,'资产管理员办理','APPROVAL','行政专员',4,NULL,'ROLE','36'),(372,29,'抄送管理人员','CC',NULL,5,'[{\"type\": \"ROLE\", \"value\": \"行政专员\"}, {\"type\": \"ROLE\", \"value\": \"财务经理\"}]',NULL,NULL),(373,30,'发起人','START',NULL,0,NULL,NULL,NULL),(374,30,'调出部门确认','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(375,30,'调入部门确认','APPROVAL','直属主管',2,NULL,'MANAGER',NULL),(376,30,'资产管理员办理','APPROVAL','行政专员',3,NULL,'ROLE','36'),(377,30,'抄送财务及内控','CC',NULL,4,'[{\"type\": \"ROLE\", \"value\": \"财务经理\"}, {\"type\": \"ROLE\", \"value\": \"内控专员\"}]',NULL,NULL),(378,31,'发起人','START',NULL,0,NULL,NULL,NULL),(379,31,'直属主管','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(380,31,'行政专员入库登记','APPROVAL','行政专员',2,NULL,'ROLE','36'),(381,31,'抄送财务经理','CC',NULL,3,'[{\"type\": \"ROLE\", \"value\": \"财务经理\"}]',NULL,NULL),(382,32,'发起人','START',NULL,0,NULL,NULL,NULL),(383,32,'直属主管','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(384,32,'会计主管&内控','APPROVAL','会计主管&内控',2,NULL,'ROLE','25'),(385,32,'会计处理','APPROVAL','核算会计',3,NULL,'ROLE','33'),(386,32,'出纳付款并上传回单','APPROVAL','出纳',4,NULL,'ROLE','29'),(387,32,'抄送财务及公司领导','CC',NULL,5,'[{\"type\": \"ROLE\", \"value\": \"财务经理\"}, {\"type\": \"ROLE\", \"value\": \"公司领导\"}]',NULL,NULL),(388,33,'发起人','START',NULL,0,NULL,NULL,NULL),(389,33,'执行总经理','APPROVAL','执行总经理',1,NULL,'ROLE','32'),(390,33,'抄送财务内控法务运营','CC',NULL,2,'[{\"type\": \"ROLE\", \"value\": \"财务经理\"}, {\"type\": \"ROLE\", \"value\": \"内控主管\"}, {\"type\": \"ROLE\", \"value\": \"法务\"}, {\"type\": \"ROLE\", \"value\": \"运营服务主管\"}]',NULL,NULL),(391,34,'发起人','START',NULL,0,NULL,NULL,NULL),(392,34,'会计（按业务类型）','APPROVAL','会计（按部门）',1,NULL,'DEPT_ACCOUNTANT',NULL),(393,34,'财务经理','APPROVAL','财务经理',2,NULL,'ROLE','38'),(394,34,'会计主管&内控','APPROVAL','会计主管&内控',3,NULL,'ROLE','25'),(395,34,'出纳','APPROVAL','出纳',4,NULL,'ROLE','29'),(396,34,'抄送相关负责人','CC',NULL,5,'[{\"type\": \"ROLE\", \"value\": \"财务经理\"}, {\"type\": \"ROLE\", \"value\": \"商务专员\"}]',NULL,NULL),(397,35,'发起人','START',NULL,0,NULL,NULL,NULL),(398,35,'交付主管','APPROVAL','交付主管',1,NULL,'ROLE','24'),(399,35,'抄送内控主管','CC',NULL,2,'[{\"type\": \"ROLE\", \"value\": \"内控主管\"}]',NULL,NULL),(400,36,'发起人','START',NULL,0,NULL,NULL,NULL),(401,36,'逐级主管','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(402,36,'会计主管&内控（涉及资金）','APPROVAL','会计主管&内控',2,NULL,'ROLE','25'),(403,36,'执行总经理','APPROVAL','执行总经理',3,NULL,'ROLE','32'),(404,36,'抄送行政','CC',NULL,4,'[{\"type\": \"ROLE\", \"value\": \"行政专员\"}]',NULL,NULL),(405,37,'发起人','START',NULL,0,NULL,NULL,NULL),(406,37,'直属主管','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(407,37,'会计主管&内控','APPROVAL','会计主管&内控',2,NULL,'ROLE','25'),(408,37,'执行总经理','APPROVAL','执行总经理',3,NULL,'ROLE','32'),(409,37,'抄送行政','CC',NULL,4,'[{\"type\": \"ROLE\", \"value\": \"行政专员\"}]',NULL,NULL),(410,38,'发起人','START',NULL,0,NULL,NULL,NULL),(411,38,'公司领导','APPROVAL','公司领导',1,NULL,'ROLE','26'),(412,38,'出纳确认','APPROVAL','出纳',2,NULL,'ROLE','29'),(413,38,'内控主管','APPROVAL','内控主管',3,NULL,'ROLE','28'),(414,38,'抄送财务法务商务','CC',NULL,4,'[{\"type\": \"ROLE\", \"value\": \"财务经理\"}, {\"type\": \"ROLE\", \"value\": \"法务\"}, {\"type\": \"ROLE\", \"value\": \"商务专员\"}]',NULL,NULL),(415,39,'发起人','START',NULL,0,NULL,NULL,NULL),(416,39,'直属主管','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(417,39,'采购询价','APPROVAL','商务专员',2,NULL,'ROLE','31'),(418,39,'行政主管（按需）','APPROVAL','行政主管',3,NULL,'ROLE','37'),(419,39,'会计主管&内控','APPROVAL','会计主管&内控',4,NULL,'ROLE','25'),(420,39,'执行总经理（≥2万元）','APPROVAL','执行总经理',5,NULL,'ROLE','32'),(421,39,'采购办理','APPROVAL','行政专员',6,NULL,'ROLE','36'),(422,39,'发起人签收','APPROVAL','直属主管',7,NULL,'INITIATOR',NULL),(423,40,'发起人','START',NULL,0,NULL,NULL,NULL),(424,40,'直属主管','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(425,40,'行政专员发放','APPROVAL','行政专员',2,NULL,'ROLE','36'),(426,40,'发起人签收','APPROVAL','直属主管',3,NULL,'INITIATOR',NULL),(427,41,'发起人','START',NULL,0,NULL,NULL,NULL),(428,41,'直属主管','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(429,41,'会计主管&内控（涉及资金）','APPROVAL','会计主管&内控',2,NULL,'ROLE','25'),(430,41,'法务','APPROVAL','法务',3,NULL,'ROLE','34'),(431,41,'法务主管','APPROVAL','法务主管',4,NULL,'ROLE','35'),(432,41,'公司领导（涉及资金）','APPROVAL','公司领导',5,NULL,'ROLE','26'),(433,41,'内控专员用印','APPROVAL','内控专员',6,NULL,'ROLE','27'),(434,41,'发起人上传归档附件','APPROVAL','直属主管',7,NULL,'INITIATOR',NULL),(435,42,'发起人','START',NULL,0,NULL,NULL,NULL),(436,42,'公司领导','APPROVAL','公司领导',1,NULL,'ROLE','26'),(437,42,'抄送内控及内控主管','CC',NULL,2,'[{\"type\": \"ROLE\", \"value\": \"内控专员\"}, {\"type\": \"ROLE\", \"value\": \"内控主管\"}]',NULL,NULL),(438,42,'发起人办理','APPROVAL','直属主管',3,NULL,'INITIATOR',NULL),(439,42,'抄送法务及商务','CC',NULL,4,'[{\"type\": \"ROLE\", \"value\": \"法务\"}, {\"type\": \"ROLE\", \"value\": \"商务专员\"}]',NULL,NULL),(440,43,'发起人','START',NULL,0,NULL,NULL,NULL),(441,43,'直属主管','APPROVAL','直属主管',1,NULL,'MANAGER',NULL),(442,43,'运营服务主管','APPROVAL','运营服务主管',2,NULL,'ROLE','39'),(443,43,'会计主管&内控','APPROVAL','会计主管&内控',3,NULL,'ROLE','25'),(444,43,'财务经理','APPROVAL','财务经理',4,NULL,'ROLE','38'),(445,43,'公司领导','APPROVAL','公司领导',5,NULL,'ROLE','26'),(446,43,'内控专员用印','APPROVAL','内控专员',6,NULL,'ROLE','27'),(447,43,'发起人归还','APPROVAL','直属主管',7,NULL,'INITIATOR',NULL),(448,43,'抄送内控主管','CC',NULL,8,'[{\"type\": \"ROLE\", \"value\": \"内控主管\"}]',NULL,NULL);
...
--
-- Dumping data for table `flow_transition`
--

LOCK TABLES `flow_transition` WRITE;
/*!40000 ALTER TABLE `flow_transition` DISABLE KEYS */;
INSERT INTO `flow_transition` (`id`, `flow_config_id`, `from_node_id`, `to_node_id`, `condition_variable`, `operator`, `expected_value`, `sort_order`) VALUES (1,1,335,336,NULL,NULL,NULL,0),(2,1,336,337,NULL,NULL,NULL,1),(3,1,337,338,NULL,NULL,NULL,2),(4,1,338,339,'amount','GREATER_THAN_OR_EQUAL','20000',3),(5,1,338,340,NULL,NULL,NULL,4),(6,1,339,340,NULL,NULL,NULL,5),(7,1,340,341,NULL,NULL,NULL,6),(8,1,341,NULL,NULL,NULL,NULL,7),(9,25,342,343,NULL,NULL,NULL,0),(10,25,343,344,NULL,NULL,NULL,1),(11,25,344,345,NULL,NULL,NULL,2),(12,25,345,346,NULL,NULL,NULL,3),(13,25,346,347,NULL,NULL,NULL,4),(14,25,347,348,NULL,NULL,NULL,5),(15,25,348,NULL,NULL,NULL,NULL,6),(16,26,349,350,NULL,NULL,NULL,0),(17,26,350,351,NULL,NULL,NULL,1),(18,26,351,352,NULL,NULL,NULL,2),(19,26,352,NULL,NULL,NULL,NULL,3),(20,27,353,354,NULL,NULL,NULL,0),(21,27,354,355,NULL,NULL,NULL,1),(22,27,355,356,NULL,NULL,NULL,2),(23,27,356,357,'amount','GREATER_THAN_OR_EQUAL','20000',3),(24,27,356,358,NULL,NULL,NULL,4),(25,27,357,358,NULL,NULL,NULL,5),(26,27,358,359,NULL,NULL,NULL,6),(27,27,359,NULL,NULL,NULL,NULL,7),(28,28,360,361,NULL,NULL,NULL,0),(29,28,361,362,NULL,NULL,NULL,1),(30,28,362,363,NULL,NULL,NULL,2),(31,28,363,364,NULL,NULL,NULL,3),(32,28,364,365,NULL,NULL,NULL,4),(33,28,365,366,NULL,NULL,NULL,5),(34,28,366,NULL,NULL,NULL,NULL,6),(35,29,367,368,NULL,NULL,NULL,0),(36,29,368,369,NULL,NULL,NULL,1),(37,29,369,370,NULL,NULL,NULL,2),(38,29,370,371,NULL,NULL,NULL,3),(39,29,371,372,NULL,NULL,NULL,4),(40,29,372,NULL,NULL,NULL,NULL,5),(41,30,373,374,NULL,NULL,NULL,0),(42,30,374,375,NULL,NULL,NULL,1),(43,30,375,376,NULL,NULL,NULL,2),(44,30,376,377,NULL,NULL,NULL,3),(45,30,377,NULL,NULL,NULL,NULL,4),(46,31,378,379,NULL,NULL,NULL,0),(47,31,379,380,NULL,NULL,NULL,1),(48,31,380,381,NULL,NULL,NULL,2),(49,31,381,NULL,NULL,NULL,NULL,3),(50,32,382,383,NULL,NULL,NULL,0),(51,32,383,384,NULL,NULL,NULL,1),(52,32,384,385,NULL,NULL,NULL,2),(53,32,385,386,NULL,NULL,NULL,3),(54,32,386,387,NULL,NULL,NULL,4),(55,32,387,NULL,NULL,NULL,NULL,5),(56,33,388,389,NULL,NULL,NULL,0),(57,33,389,390,NULL,NULL,NULL,1),(58,33,390,NULL,NULL,NULL,NULL,2),(59,34,391,392,NULL,NULL,NULL,0),(60,34,392,393,NULL,NULL,NULL,1),(61,34,393,394,NULL,NULL,NULL,2),(62,34,394,395,NULL,NULL,NULL,3),(63,34,395,396,NULL,NULL,NULL,4),(64,34,396,NULL,NULL,NULL,NULL,5),(65,35,397,398,NULL,NULL,NULL,0),(66,35,398,399,NULL,NULL,NULL,1),(67,35,399,NULL,NULL,NULL,NULL,2),(68,36,400,401,NULL,NULL,NULL,0),(69,36,401,402,'involvesFunds','EQUAL','true',1),(70,36,401,403,NULL,NULL,NULL,2),(71,36,402,403,NULL,NULL,NULL,3),(72,36,403,404,NULL,NULL,NULL,4),(73,36,404,NULL,NULL,NULL,NULL,5),(74,37,405,406,NULL,NULL,NULL,0),(75,37,406,407,NULL,NULL,NULL,1),(76,37,407,408,NULL,NULL,NULL,2),(77,37,408,409,NULL,NULL,NULL,3),(78,37,409,NULL,NULL,NULL,NULL,4),(79,38,410,411,NULL,NULL,NULL,0),(80,38,411,412,NULL,NULL,NULL,1),(81,38,412,413,NULL,NULL,NULL,2),(82,38,413,414,NULL,NULL,NULL,3),(83,38,414,NULL,NULL,NULL,NULL,4),(84,39,415,416,NULL,NULL,NULL,0),(85,39,416,417,NULL,NULL,NULL,1),(86,39,417,418,NULL,NULL,NULL,2),(87,39,418,419,NULL,NULL,NULL,3),(88,39,419,420,'amount','GREATER_THAN_OR_EQUAL','20000',4),(89,39,419,421,NULL,NULL,NULL,5),(90,39,420,421,NULL,NULL,NULL,6),(91,39,421,422,NULL,NULL,NULL,7),(92,39,422,NULL,NULL,NULL,NULL,8),(93,40,423,424,NULL,NULL,NULL,0),(94,40,424,425,NULL,NULL,NULL,1),(95,40,425,426,NULL,NULL,NULL,2),(96,40,426,NULL,NULL,NULL,NULL,3),(97,41,427,428,NULL,NULL,NULL,0),(98,41,428,429,'involvesFunds','EQUAL','true',1),(99,41,428,430,NULL,NULL,NULL,2),(100,41,429,430,NULL,NULL,NULL,3),(101,41,430,431,NULL,NULL,NULL,4),(102,41,431,432,'involvesFunds','EQUAL','true',5),(103,41,431,433,NULL,NULL,NULL,6),(104,41,432,433,NULL,NULL,NULL,7),(105,41,433,434,NULL,NULL,NULL,8),(106,41,434,NULL,NULL,NULL,NULL,9),(107,42,435,436,NULL,NULL,NULL,0),(108,42,436,437,NULL,NULL,NULL,1),(109,42,437,438,NULL,NULL,NULL,2),(110,42,438,439,NULL,NULL,NULL,3),(111,42,439,NULL,NULL,NULL,NULL,4),(112,43,440,441,NULL,NULL,NULL,0),(113,43,441,442,NULL,NULL,NULL,1),(114,43,442,443,NULL,NULL,NULL,2),(115,43,443,444,NULL,NULL,NULL,3),(116,43,444,445,NULL,NULL,NULL,4),(117,43,445,446,NULL,NULL,NULL,5),(118,43,446,447,NULL,NULL,NULL,6),(119,43,447,448,NULL,NULL,NULL,7),(120,43,448,NULL,NULL,NULL,NULL,8);
/*!40000 ALTER TABLE `flow_transition` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
