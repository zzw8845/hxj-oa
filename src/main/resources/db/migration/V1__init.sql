...
INSERT INTO `form_template` (`id`, `business_type`, `name`, `doc_prefix`, `flow_config_id`, `version`, `status`, `sort_order`, `category`, `attachment_requirements`) VALUES (1,'DAILY_PAYMENT','费用报销','BX',1,1,'ENABLED',0,'DAILY_PAYMENT','["发票","收款信息"]');
...
INSERT INTO `flow_config` (`id`, `type`, `category`, `nodes`, `created_at`, `updated_at`, `status`, `version`) VALUES (1,'费用报销','DAILY',NULL,'2026-09-15 10:00:00','2026-09-15 10:00:00','PUBLISHED',1);
...
INSERT INTO `flow_transition` (`id`, `flow_config_id`, `from_node_id`, `to_node_id`, `condition_variable`, `operator`, `expected_value`, `sort_order`) VALUES (1,1,1,2,NULL,NULL,NULL,0),(2,1,2,3,NULL,NULL,NULL,1),(3,1,3,4,'amount','GREATER_THAN_OR_EQUAL','20000',2),(4,1,3,5,NULL,NULL,NULL,3),(5,1,4,5,NULL,NULL,NULL,4),(6,1,5,6,NULL,NULL,NULL,5),(7,1,6,NULL,NULL,NULL,NULL,6);
